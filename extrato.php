...
<div class="col-xs-12">
	...
	<div align="center">
		...
		<br/>
		<p class="subtext">Prezado funcionário, por favor, insira o código do cliente abaixo para conferir os respectivos gastos.</p><br/>
		<br/>
		<div class="col-xs-12">
					<br/>
					<form class="form-horizontal" action="extrato2.php" method="POST">
